...
| `docs/07_美术需求文档.md` | v3.0 暗黑卡通风格总纲、色板、背景/角色/图标/UI/特效需求、P0-P2 优先级 |
| `docs/08_AI生图提示词.md` | AI 生图提示词合集（Midjourney/DALL-E/SD），v3.0 风格需按头部说明自行转换 |
| `docs/09_NanoBanana提示词.md` | Nano Banana 专用生图提示词，中英双语，v3.0 风格需按头部说明自行转换 |
| `docs/10_酿造系统需求文档.md` | 香料改造（删 SeasoningZone + 食物属性）、酿造系统（时间酿造 + 随机事件 + 神秘配方） |
| `docs/11_合成物理效果需求文档.md` | 合成区拖拽物理：抓起摇晃、惯性拖拽、下落弹跳、脱靶回弹、香料粉末粒子 |
