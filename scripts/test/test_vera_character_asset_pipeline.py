...
EXPRESSION_SHEET = RAW / "vera_expression_sheet_source_v2.png"
EXPRESSION_PROMPT = RAW / "vera_expression_sheet_prompt_v2.txt"
LEDGE_SOURCE = RAW / "vera_ledge_source_v3.png"
LEDGE_PROMPT = RAW / "vera_ledge_prompt_v3.txt"
...
CONTACT_SHEET_VARIANTS = ["neutral", "smirk", "concerned", "surprised", "ledge"]
COLOR_LIMIT = 72
VARIANT_CROPS = {
...
class VeraCharacterAssetPipelineTest(unittest.TestCase):
    ...
    def test_exporter_uses_explicit_source_contract(self) -> None:
        ...
        self.assertIn("vera_expression_sheet_source_v2.png", source, "Vera formal source must be the expression sheet with neutral and variants")
        ...
        self.assertIn('"neutral": (104, 20, 570, 620)', source, "neutral Vera must be cropped from the same expression source sheet")
    ...
    def test_manifest_records_vera_character_asset(self) -> None:
        ...
        self.assertEqual(
            ...
            "art_sources/generated_raw/characters/vera/vera_expression_sheet_source_v2.png",
        )
        self.assertEqual(
            data.get("prompt"),
            "art_sources/generated_raw/characters/vera/vera_expression_sheet_prompt_v2.txt",
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            {
                "id": ASSET_ID,
                "source_file": "art_sources/generated_raw/characters/vera/vera_expression_sheet_source_v2.png",
                "prompt": "art_sources/generated_raw/characters/vera/vera_expression_sheet_prompt_v2.txt",
        ...
        for variant in VARIANTS:
            ...
            source_file = "art_sources/generated_raw/characters/vera/vera_expression_sheet_source_v2.png"
            prompt_file = "art_sources/generated_raw/characters/vera/vera_expression_sheet_prompt_v2.txt"
            ...
            if variant == "ledge":
                source_file = "art_sources/generated_raw/characters/vera/vera_ledge_source_v3.png"
                prompt_file = "art_sources/generated_raw/characters/vera/vera_ledge_prompt_v3.txt"
                intended_use = "TutorialOverlay Vera character portrait raised dialogue edge pose"
            self.assertEqual(
                assets[variant_id],
                {
                    "id": variant_id,
    ...
    def test_contact_sheet_uses_standard_character_grid_without_duplicate_base(self) -> None:
        ...
        empty_x, empty_y = CONTACT_SHEET_NATIVE_POSITIONS[5]
        empty_slot = contact.crop((
            empty_x,
            empty_y,
            empty_x + CONTACT_SHEET_NATIVE_PREVIEW_SIZE[0],
            empty_y + CONTACT_SHEET_NATIVE_PREVIEW_SIZE[1],
        ))
        expected_empty = Image.new("RGB", CONTACT_SHEET_NATIVE_PREVIEW_SIZE, CONTACT_SHEET_NATIVE_BG)
        self.assertEqual(
            empty_slot.tobytes(),
            expected_empty.tobytes(),
            "Vera contact sheet sixth slot should remain empty; do not duplicate vera and vera_neutral",
        )
