...
ITEMS = [
    ...
    ("cave_mushroom_stew", "assets/textures/tavern/items/cave_mushroom_stew.png"),
    ("rock_lizard_steak", "assets/textures/tavern/items/rock_lizard_steak.png"),
    ("old_road_wine", "assets/textures/tavern/items/old_road_wine.png"),
    ("miner_dark_ale", "assets/textures/tavern/items/miner_dark_ale.png"),
]
...
class RareGatheringAssetPipelineTest(unittest.TestCase):
    def test_raw_sources_and_manifest_are_retained(self) -> None:
        ...
        for filename in [
            ...
            "rare_upgrade_items_sheet_v1.png",
    ...
    def test_icons_are_visible_and_restrained_pixel_assets(self) -> None:
        for item_id, _runtime_rel in ITEMS:
            with self.subTest(item_id=item_id):
                ...
                self.assertLessEqual(len(set(visible)), 34, f"{item_id}: palette should stay restrained")
                self.assertGreater(
