...
const PINNED_NOTE_NAME_POS := Vector2(148, 96)
const PINNED_NOTE_NAME_SIZE := Vector2(172, 34)
const PINNED_NOTE_DESC_POS := Vector2(128, 142)
const PINNED_NOTE_DESC_SIZE := Vector2(196, 76)
const PINNED_NOTE_COST_POS := Vector2(120, 224)
